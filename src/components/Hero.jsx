      ...
      <div className="max-w-7xl h-screen flex flex-col items-center justify-center mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center relative">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-gray-100 mb-8">
            ...
            <div className="relative inline-block">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600"> Segmentation AI</span>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="group bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">Neural Networks</h3>
            <p className="text-gray-600 dark:text-gray-300">Advanced deep learning models trained on extensive medical datasets.</p>
          </div>
          ...
          <div className="group bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">Real-time Processing</h3>
            <p className="text-gray-600 dark:text-gray-300">Lightning-fast segmentation results in milliseconds.</p>
          </div>
          ...
          <div className="group bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100">High Accuracy</h3>
            <p className="text-gray-600 dark:text-gray-300">99.9% accuracy in identifying and segmenting medical images.</p>
          </div>
        </div>
      </div>
    </div>
